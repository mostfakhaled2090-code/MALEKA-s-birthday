...
export default function LoadingScreen({
  ...
  if (!mounted) {
    return <div className="min-h-screen bg-[#030000]" />;
  }
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#050101] text-white flex flex-col items-center justify-center font-sans selection:bg-white/10">
      ...
      <div className="relative z-30 flex flex-col items-center justify-center w-full max-w-4xl px-6 py-20 text-center">
        ...
        <h1
          className="animate-stagger-2 text-3xl md:text-5xl lg:text-6xl font-light text-white/95 mb-6 tracking-wide drop-shadow-lg"
          style={{
        ...
        <div
          className="animate-stagger-5 flex items-center justify-center gap-4 md:gap-8 mb-24"
          dir="ltr"
        >
...
function Stars({
  ...
  return (
    <div
      ...
      style={{
        transform: `translate(${
          mousePos.x * (isMobile ? 0 : -30)
        }px, ${
          mousePos.y * (isMobile ? 0 : -30)
        }px)`,
      }}
    >
      {stars.map((s) => (
        <div
          ...
          style={{
            ...
            ["--min-opacity" as string]:
              s.minOpacity,
            ["--max-opacity" as string]:
              s.maxOpacity,
          }}
        />
      ))}
